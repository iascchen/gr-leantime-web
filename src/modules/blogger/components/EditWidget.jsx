...
import IsBannedInput from './IsBannedInput'
import {CREATE_BLOGGER, FETCH_BLOGGER, UPDATE_BLOGGER} from '../graphql'
...
const EditWidget = () => {
    ...
    const { error, data } = useQuery(FETCH_BLOGGER, {
        variables: { id },
        skip: !id
    })
    const [createBlogger] = useMutation(CREATE_BLOGGER)
    const [updateBlogger] = useMutation(UPDATE_BLOGGER)
